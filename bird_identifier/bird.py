...
def findImages():
    ...
    for image in os.listdir("../images"):
        ...
        if image.endswith(".jpg"):
            ...
            result = run_inference_on_image(f"../images/{image}")
            src_path = f"../images/{image}"
            dst_path = f"../identified_images/{result}_{image[5:]}"
            shutil.move(src_path, dst_path)
            print(f"Copied {image} to identified_images directory")
